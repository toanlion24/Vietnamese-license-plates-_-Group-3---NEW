...
def run_batch(args: argparse.Namespace) -> None:
    pipeline = PlateInferencePipeline(detector=_build_detector(args), ocr=_build_ocr(args))
...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument("--ocr-backend", choices=["easyocr", "trocr", "dummy"], default="easyocr")
